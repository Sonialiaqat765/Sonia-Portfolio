    ...
    <div className="py-25 max-w-169 mx-auto px-2">
      <div className="text-center">
        ...
        <p className="text-[#A5ACB5] text-xs sm:text-lg font-normal text-center pb-8">
          I’m passionate about turning ideas into impactful projects. Whether it’s a website, app, or creative solution, let’s collaborate and create something remarkable together.
        </p>
        <a
          href="#!"
